...
const Presentation = props => {
    ...
    return (
        <div  id="intro" className="home__presentation__bigContainer">
            <div className='transition__background'></div>
                <div className='home__presentation--background'>
                    <div className='home__presentation' >
                        ...
                        <div className='home__intro_container'>
                            <div>
                            <p>{ allData[language].presentationText }</p>
                            ...
                            <div className='home__intro_square--container'>
                                <div className='home__intro_square--1'><img src={temporaryPortrait} alt="self-portrait"/></div>
                                <a className='home__intro_square--2--grid' href={language === 'fr' ? resumeFr : resumeEn } ><img src={downloadPdf} alt="pdf-icon"/></a>
                                </div>
                        </div>
                </div>
            </div>
